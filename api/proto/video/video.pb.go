...
const file_api_proto_video_proto_rawDesc = "" +
	"\n" +
	"\x15api/proto/video.proto\x12\x05video\"\x87\x02\n" +
	"\x05Video\x12\x0e\n" +
	...
	"isFavorite\x12\x16\n" +
	"\x06status\x18\t \x01(\x05R\x06status\"S\n" +
...
var file_api_proto_video_proto_depIdxs = []int32{
	0, // 0: video.FeedResponse.video_list:type_name -> video.Video
	3, // 1: video.VideoService.Feed:input_type -> video.FeedRequest
	1, // 2: video.VideoService.PublishVideo:input_type -> video.PublishRequest
	5, // 3: video.VideoService.DeleteVideo:input_type -> video.DeleteRequest
	7, // 4: video.VideoService.AuditVideo:input_type -> video.AuditRequest
	4, // 5: video.VideoService.Feed:output_type -> video.FeedResponse
	2, // 6: video.VideoService.PublishVideo:output_type -> video.PublishResponse
	6, // 7: video.VideoService.DeleteVideo:output_type -> video.DeleteResponse
	8, // 8: video.VideoService.AuditVideo:output_type -> video.AuditResponse
